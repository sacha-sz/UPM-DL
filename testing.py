...
def test_model(model_file, file_name, color_dir, gray_dir=None, architecture=1, show_images=True, batch=5):
    """
...
def calculate_loss(model_file, file_name, color_dir, gray_dir=None, architecture=1, batch=32):
    """
